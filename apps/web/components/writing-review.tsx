...
export function WritingReview() {
  ...
  return <details className="mt-4 border-t border-white/10 pt-3">
    ...
    <p className="mt-2 text-xs leading-5 text-mist">Suggestions for unfinished text, empty sections, repetition, heading hierarchy, and readability. These checks do not verify facts, judge your experience, or affect schema validation.</p>
