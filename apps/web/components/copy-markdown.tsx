...
export function CopyMarkdown() {
  ...
  return <div className="mt-4 border-t border-white/10 pt-3">
    ...
    <p className="mt-2 text-xs leading-5 text-mist">Copies draft text, including frontmatter and any validation errors, to your system clipboard. Your device may normalize line endings. A clipboard copy is not a saved file; download the .md source when exact bytes matter.</p>
