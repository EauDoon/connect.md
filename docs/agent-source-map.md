...
Agents reading this repository should start at [`/llms.txt`](../llms.txt).

| Path | Why it exists |
| --- | --- |
| [`llms.txt`](../llms.txt) | Honest source-tree discovery. Not a grant. |
| [`packages/markdown-schemas`](../packages/markdown-schemas/README.md) | Canonical Profile / Resume / Post contracts |
